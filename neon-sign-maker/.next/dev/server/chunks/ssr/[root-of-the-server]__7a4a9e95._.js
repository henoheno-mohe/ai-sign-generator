...
"[project]/neon-sign-maker/src/components/HeroBeforeAfter.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const LS_BEFORE = "neon-sign-maker-hero-before-v1";
const LS_AFTER = "neon-sign-maker-hero-after-v1";
function pickColors() {
    // ロボくんはビビッドに見せたい：pink + green + lemon yellow
    const byId = (id)=>__TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$palette$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEON_PALETTE_14"].find((c)=>c.id === id);
    return [
        byId("pink"),
        byId("green"),
        byId("lemon-yellow")
...
function drawHanddrawnRobot(ctx, w, h) {
    ctx.fillStyle = "#ffffff";
    ctx.fillRect(0, 0, w, h);
    ctx.save();
    ctx.translate(w * 0.18, h * 0.18);
    const jitter = (v)=>v + (Math.random() - 0.5) * 2.2;
    ctx.lineWidth = 10;
    ctx.lineCap = "round";
    ctx.lineJoin = "round";
    ...
    const drawOnce = ()=>{
        ...
        const x = jitter(0);
        const y = jitter(18);
        const rw = jitter(w * 0.46);
        const rh = jitter(h * 0.42);
        const r = 32;
        roundedRect(ctx, x, y, rw, rh, r);
        ctx.stroke();
        // antenna
        ctx.beginPath();
        ctx.moveTo(jitter(rw * 0.5), jitter(8));
        ctx.lineTo(jitter(rw * 0.5), jitter(18));
        ctx.stroke();
        ctx.beginPath();
        ctx.arc(jitter(rw * 0.5), jitter(4), 10, 0, Math.PI * 2);
        ctx.stroke();
        // eyes (two squares)
        const ey = y + rh * 0.34;
        const ex1 = x + rw * 0.22;
        const ex2 = x + rw * 0.62;
        rect(ctx, jitter(ex1), jitter(ey), 42, 42);
        rect(ctx, jitter(ex2), jitter(ey), 42, 42);
        ctx.stroke();
        // mouth slit
        ctx.beginPath();
        ctx.moveTo(jitter(x + rw * 0.30), jitter(y + rh * 0.66));
        ctx.lineTo(jitter(x + rw * 0.70), jitter(y + rh * 0.66));
        ctx.stroke();
    };
    // draw multiple passes to feel hand-drawn
    drawOnce();
    ctx.globalAlpha = 0.8;
    drawOnce();
...
async function createBeforePngDataUrl() {
    const canvas = document.createElement("canvas");
    canvas.width = 900;
    canvas.height = 600;
    const ctx = canvas.getContext("2d");
    if (!ctx) throw new Error("Canvas not available");
    drawHanddrawnRobot(ctx, canvas.width, canvas.height);
    return canvas.toDataURL("image/png");
}
function HeroBeforeAfter() {
    const [state, setState] = __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useState({
        beforeDataUrl: null,
        afterDataUrl: null,
        isGenerating: false,
        error: null
    });
    __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useEffect(()=>{
        const before = localStorage.getItem(LS_BEFORE);
        const after = localStorage.getItem(LS_AFTER);
        if (before) {
            setState((s)=>({
                    ...s,
                    beforeDataUrl: before,
                    afterDataUrl: after || null
                }));
            return;
        }
        (async ()=>{
            try {
                const d = await createBeforePngDataUrl();
                localStorage.setItem(LS_BEFORE, d);
                setState((s)=>({
                        ...s,
                        beforeDataUrl: d,
                        afterDataUrl: after || null
                ...
                setState((s)=>({
                        ...s,
                        error: e instanceof Error ? e.message : "before生成に失敗しました"
                    }));
            }
        })();
    }, []);
    async function generateAfter() {
        if (!state.beforeDataUrl || state.isGenerating) return;
        setState((s)=>({
                ...s,
                isGenerating: true,
                error: null
        ...
        try {
            const resp = await fetch("/api/neon/generate", {
                ...
                body: JSON.stringify({
                    sketchDataUrl: state.beforeDataUrl,
                    text: "",
                    colors: pickColors(),
                    widthMm: 600,
                    tubeDiameter: 7
            ...
            localStorage.setItem(LS_AFTER, data.imageDataUrl);
            setState((s)=>({
                    ...s,
                    afterDataUrl: data.imageDataUrl,
                    isGenerating: false
                }));
        } catch (e) {
            setState((s)=>({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                fileName: "[project]/neon-sign-maker/src/components/HeroBeforeAfter.tsx",
                                lineNumber: 180,
                                columnNumber: 11
                            }, this),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mt-2 aspect-[3/2] w-full overflow-hidden rounded-lg bg-white/5 grid place-items-center",
                                children: state.beforeDataUrl ? // eslint-disable-next-line @next/next/no-img-element
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                    ...
                                    lineNumber: 184,
                                    columnNumber: 15
                                }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    !state.afterDataUrl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        type: "button",
                                        onClick: generateAfter,
                                        disabled: !state.beforeDataUrl || state.isGenerating,
                                        className: [
                                            "rounded-full px-3 py-1 text-xs font-semibold transition-colors",
                                            !state.beforeDataUrl || state.isGenerating ? "bg-white/10 text-zinc-500 cursor-not-allowed" : "bg-fuchsia-300 text-black hover:bg-fuchsia-200"
                                        ].join(" "),
                                        children: state.isGenerating ? "作成中..." : "サンプル生成"
                                    }, void 0, false, {
                                        fileName: "[project]/neon-sign-maker/src/components/HeroBeforeAfter.tsx",
                                        lineNumber: 194,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mt-2 aspect-[3/2] w-full overflow-hidden rounded-lg bg-white/5 grid place-items-center",
                                children: state.afterDataUrl ? // eslint-disable-next-line @next/next/no-img-element
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                    src: state.afterDataUrl,
                                    alt: "After（ネオン仕上がり）",
                                    className: "h-full w-full object-contain"
                                }, void 0, false, {
                                    fileName: "[project]/neon-sign-maker/src/components/HeroBeforeAfter.tsx",
            ...
            state.error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
"[project]/neon-sign-maker/src/components/ColorPicker14Dynamic.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ColorPicker14Dynamic({ palette, colors, onChange, maxColors = 5 }) {
    const [activeIndex, setActiveIndex] = __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useState(0);
    __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useEffect(()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: colors.map((c, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(SlotButton, {
                        label: slotLabel(idx),
                        color: c,
...
"[project]/neon-sign-maker/src/lib/neonProtocol.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/neon-sign-maker/src/lib/quote.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/neon-sign-maker/src/lib/lineLength.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/neon-sign-maker/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/neon-sign-maker/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$components$2f$HeroBeforeAfter$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/neon-sign-maker/src/components/HeroBeforeAfter.tsx [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$components$2f$ColorPicker14Dynamic$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/neon-sign-maker/src/components/ColorPicker14Dynamic.tsx [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$neonProtocol$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/neon-sign-maker/src/lib/neonProtocol.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$quote$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/neon-sign-maker/src/lib/quote.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$lineLength$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/neon-sign-maker/src/lib/lineLength.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function StudioClient() {
    ...
    const [colorCount, setColorCount] = __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useState(3);
    const [colors, setColors] = __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useState(()=>[
            __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$palette$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEON_PALETTE_14"][0],
            __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$palette$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEON_PALETTE_14"][5],
            __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$palette$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEON_PALETTE_14"][9]
        ]);
    const [widthMm, setWidthMm] = __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useState(600);
    const tubeDiameter = __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$neonProtocol$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEON_PROTOCOL_V1"].defaultTubeDiameter;
    const [isGenerating, setIsGenerating] = __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useState(false);
    const [aiImageDataUrl, setAiImageDataUrl] = __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useState(null);
    const [aiError, setAiError] = __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useState(null);
    const [isEstimating, setIsEstimating] = __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useState(false);
    const [tubeLengthCm, setTubeLengthCm] = __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useState(null);
    const unitYenPerCm = __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$quote$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FIXED_YEN_PER_CM_TUBE"];
    const canGenerate = Boolean(sketchDataUrl || text.trim());
    const background = (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$backgrounds$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDefaultBackground"])();
    const priceYenExTax = tubeLengthCm == null ? null : (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$quote$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["estimatePriceYenExTaxFromTubeLength"])(tubeLengthCm, unitYenPerCm);
    // 色数変更に追従して配列を増減
    __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useEffect(()=>{
        ...
        setColors((prev)=>{
            ...
            while(next.length < n)next.push(__TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$palette$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEON_PALETTE_14"][Math.min(next.length, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$palette$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEON_PALETTE_14"].length - 1)]);
            return next;
        });
    }, [
        colorCount
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$components$2f$HeroBeforeAfter$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                    fileName: "[project]/neon-sign-maker/src/app/studio/studio-client.tsx",
                    lineNumber: 70,
                    columnNumber: 9
                }, this),
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                4,
                                5
                            ].map((n)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    type: "button",
                                    onClick: ()=>{
                                        setColorCount(n);
                                        setAiImageDataUrl(null);
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$components$2f$ColorPicker14Dynamic$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    onClick: async ()=>{
                                        ...
                                        try {
                                            ...
                                            const est = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$lineLength$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["estimateTubeLengthCmFromNeonPhoto"])({
                        ...
                        !canGenerate && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "mt-3 text-xs text-zinc-400",
                        ...
                        aiError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: priceYenExTax == null ? "—" : `¥${(0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$quote$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatYen"])(priceYenExTax)}`
                                        }, void 0, false, {
                                            fileName: "[project]/neon-sign-maker/src/app/studio/studio-client.tsx",
                                            lineNumber: 235,
                                            columnNumber: 17
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            children: [
                                                "・単価（固定）: ¥",
                                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$neon$2d$sign$2d$maker$2f$src$2f$lib$2f$quote$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatYen"])(unitYenPerCm),
                                                " / cm"
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/neon-sign-maker/src/app/studio/studio-client.tsx",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7a4a9e95._.js.map