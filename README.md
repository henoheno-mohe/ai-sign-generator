...
このプロジェクトには、iPad mini 3などの古いデバイスをフォトフレーム専用デバイスに変身させるPWAアプリも含まれています。

### 特徴
- ✅ Google Drive連携（容量8GBでもOK）
- ✅ PWA対応（アプリのように使える）
- ✅ 日付フォルダで自動管理
- ✅ タッチ操作対応（スワイプ、タップ、長押し）
- ✅ 時間帯スリープ機能
- ✅ ランダム再生
- ✅ カスタマイズ可能な設定
...
フォトフレーム機能の詳しい使い方とセットアップ手順は、以下のドキュメントをご覧ください：

📖 **[フォトフレーム完全ガイド](docs/PHOTOFRAME_GUIDE.md)**

### クイックスタート

```bash
# セットアップスクリプトを実行
./scripts/setup-photoframe.sh

# 開発サーバーを起動
npm run dev

# ブラウザで http://localhost:3000/photoframe にアクセス
```
